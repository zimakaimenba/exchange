...
import com.exchangeinfomanager.Core.Nodexdata.NodexdataForJFC.BanKuaiXPeriodDataForJFC;
...
//	private static Logger logger = Logger.getLogger(BanKuai.class);
	...
	private String bankuaileixing; // 通达信里面定义的板块有几种：1.有个股自身有成交量数�? 2. 有个股自身无成交量数�? 3.无个股自身有成交量数�?
	
	private List<BkChanYeLianTreeNode> stockofbklist; //存放�?有的个股
