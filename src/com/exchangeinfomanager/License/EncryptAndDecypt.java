...
public class EncryptAndDecypt 
{
	...
	public String getEncryptedPassowrd (String originalPassword)
	{
	...
	public String getDecryptedPassowrd (String encryptedPassword)
	{
    ...
    public static void main(String[] args) {  
      ...
      String decryptedPassword = tip.getDecryptedPassowrd(encryptedPassword);
      System.out.println("Decrypted password: " + decryptedPassword);

      
      
      originalPassword = "74-46-A0-A8-2A-FD";
      
      System.out.println("Original password: " + originalPassword);
      encryptedPassword = tip.getEncryptedPassowrd(originalPassword);
      System.out.println("Encrypted password: " + encryptedPassword);
      decryptedPassword = tip.getDecryptedPassowrd(encryptedPassword);
      System.out.println("Decrypted password: " + decryptedPassword);
